...
*Pravokotna projekcija sledi iz tega da vzamemo sinus kota med vektorjema, potem pomnožimo z dolžino $a$ da dobimo dolžino vektorja na $b$-ju - da bo to skalar za $b$ moramo to deliti še z $|b|$ če to zapišemo je to $\frac{\sin a \cdot |a|}{|b|}b$ oz. če pomnožimo zgoraj in spodaj z $|b|$ dobimo $\frac{\langle a,b \rangle }{\langle b,b \rangle }b$ kar je ortogonalna projekcija $a$ na $b$. Če hočemo poljubne vektorje narediti ortogonalne lahko vzamemo naša $a$ in $b$ ter pr projekcijo $a$ na $b$ in jo odštejemo $a$-ju, če si predstavljamo $b$ ostane tak kot je $a$ pa po odštetju svoje pravokotne projekcije na $b$ postane pravokoten $b$-ju.*
